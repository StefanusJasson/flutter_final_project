  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<LanguageCubit, LanguageState>(
      builder: (context, state) {
        String animeTitle = '';
        String animeSubtitle = '';
        if(state.language == 'Jp') {
          animeTitle = animeSeason.title as String;
          animeSubtitle = animeSeason.titleEnglish as String;
        }
        else {
          animeTitle = animeSeason.titleEnglish as String;
          animeSubtitle = animeSeason.title as String;
        }
        return Scaffold(
          appBar: AppBar(
          ...
          body: ListView(
            ...
            children: [
              ...
              Image.network(animeSeason.image as String, fit: BoxFit.fill),
              Container(height: 10),
              Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ListTile(
                          title: Text(
                            '${(animeSeason.season)?.capitalize()} ${animeSeason.year}',
                          ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      itemCount:
                          animeSeason.characters == null
                              ? 0
                              : animeSeason.characters?.length,
                            ...
                            children: [
                              Column(
                                children: [
                                  ...
                                  Image.network(
                                    animeSeason
                                        .characters?[index]['seiyuu_image'],
                                    height: 200,
                                  ),
                                  Text(
                                    animeSeason.characters?[index]['seiyuu'],
                                  ),
                                ],
                              ),
                            ],
